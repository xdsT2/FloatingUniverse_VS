...
;
; Translation maintained by various contributors
; Latest: https://github.com/kira-96/Inno-Setup-Chinese-Simplified-Translation
...
ConfirmDeleteSharedFile2=系统中包含的下列共享文件已经不再被其它程序使用。