...
public:
    ...
    int themeMode = 2; // 主题模式：0=浅色，1=深色，2=跟随系统
...
// 获取当前实际主题模式（深色=true，浅色=false）
// themeMode: 0=浅色，1=深色，2=跟随系统
inline bool isDarkTheme()
{
    if (us->themeMode == 0) return false; // 浅色
    if (us->themeMode == 1) return true;  // 深色
    // 跟随系统
#ifdef Q_OS_WIN32
